...
from shop.customer.models import Customer, Order, Product, Category
...
def dashboard_page():
    ...
    return render_template('admin/dashboard.html', title='dashboard', total_cost=total_cost, total_orders=total_orders, customers=customers, total_customers=total_customers, orders=orders)
...
def allCustomer_page():
    ...
    return render_template('admin/all_customer.html', title='all-customers', customers=customers, total_customer=total_customer)
...
def allProduct_page():
    ...
    return render_template('admin/allProduct.html', title='all-product', products=products, total_products=total_products)
...
def addProduct_page():
    ...
    return render_template('admin/addProduct.html', title='add-product', form=form)
...
def editProduct_page(product_id):
    ...
    return render_template('admin/editProduct.html', title='edit-product', form=form, product=product)
...
def allOrder_page():
    ...
    return render_template('admin/allOrder.html',title='all-orders', orders=orders, total_orders=total_orders, total_price=total_price, form=form)
...
def update_order(order_id):
    ...
    return render_template('admin/edit_order.html', title='update-order', form=form, order=order)
...
def addCategory_page():
    ...
    return render_template('admin/addCategory.html',title='add-category', form=form, categories=categories, total_categories=total_categories)
...
def editCategory_page(category_id):
    ...
    categories = Category.query.all()
    return render_template('admin/editCategory.html', title='edit-category', form=form, categories=categories, category=category)
...
def setting_page():
    ...
    return render_template('admin/setting.html',title='profile', form=form)
